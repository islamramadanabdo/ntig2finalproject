                        ...
                        <?php foreach( $selectResult as $item  ){  ?>
                            <tr>
                                ...
                                <td>
                                  ...
                                  <a href="/ntig2test/dashboard/admin/courses/edit.php?edit=<?php echo $item['id']  ?>" class="btn btn-primary">Edit</a>
                                  <a href="/ntig2test/dashboard/admin/courses/show.php?show=<?php echo $item['id']  ?>" class="btn btn-info">Show</a>
                                </td>
                            </tr>
                        <?php } ?>
                      </table>
